...
- **Project**: Sync Docs with Git

- **Description**: Streamline documentation management by automatically syncing documents to a Git repository, ensuring version control and collaborative editing
...
- **Description**: A chatbot in graphRAG for the autonomous car community
...
- **Description**: BBB Video conference live note taking and AI summary with Docs 
...
- **Description**: Collaborative whiteboard in Meet and Drive
...
- **Project**: Telephony bridge for Tchap

- **Description**: A seamless integration connecting Tchap with telephony services, enabling voice communication and enhancing collaboration.
...
- **Project**: Integrating La Suite in a 2D virtual world
...
- **Project**: Visio Room Connector

- **Description**: Make Meet compatible with real-world video conference rooms (SIP Video Interoperability)
...
- **Project**: Matrix : Element X Web

- **Description**: Create a next generation Matrix client. Fast, reliable, familiar and simple. Using the rust SDK and the new web bindings
...
- **Description**: A multi-level operating system built on NixOS, designed for La Suite Numérique to securely isolate, manage, and reproducibly deploy digital public services across trust zones.
