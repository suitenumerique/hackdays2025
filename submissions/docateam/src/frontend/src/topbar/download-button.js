      ...
      content={
        <Menu>
          <li className="bp5-menu-header">
            <h6 className="bp5-heading">Type de fichier</h6>
          </li>
          <HTMLSelect
            fill
            onChange={(e) => {
          ...
          {type !== 'json' && type !== 'html' && type !== 'svg' && (
            <>
              <li className="bp5-menu-header">
                <h6 className="bp5-heading">Qualité</h6>
              </li>
		...
		Le format JSON est utilisé pour enregistrer et charger des projets.
		Vous pouvez sauvegarder votre projet et le charger ensuite via Fichier → Ouvrir
              </div>
            </>
          )}
          {type === 'mp4' && (
